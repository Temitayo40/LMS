        ...
        <>
            <div
              ...
              {courseData.educator.name}
                                        ...
                                        <ul className="list-disc md:pl-10 pl-4 pr-4 py-2 text-gray-600 border-t border-gray-300">
                                            {chapter.chapterContent.map((lecture, index) => (
                                                <li key={index} className="flex items-start gap-2 py-1">
                                                    ...
                                                    />
                                                    <div
                                                        className="flex items-center justify-between w-full text-gray-800 text-xs md:default">
                ...
                {/* right column */}
                <div
                    className="max-w-[var(--course-card)] z-10 shadow-[var(--custom-card)] rounded-t md:rounded-none overflow-hidden bh-white min-w-[300px] sm:min-w-[420px]">
                    {playerData ? (
                        <YouTube
