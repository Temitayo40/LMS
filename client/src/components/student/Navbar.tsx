    ...
    return (
        ...
        >
            ...
            <div className="md:hidden relative flex items-center gap-2 sm:gap-5 text-gray-500">
                ...
                {toggleBurger && user && (
                    <div
                        className={toggleBurger && `absolute top-8 right-0 z-50 w-52 px-2 py-4 bg-white rounded-xl shadow-xl border border-gray-200 text-sm flex flex-col gap-3`}>
                        ...
                        {user && (
                            <div className="flex flex-col gap-2 text-gray-700">
                                <button
                                    ...
                                    className="text-left border-l-4 p-2 border-blue-600 hover:text-blue-600 hover:border-b rounded-sm hover:bg-gray-100 transition-colors"
                                >
                                    {isEducator ? "Educator DashboardModel" : "Become Educator"}
                                </button>
                                <Link
                                    to="/my-enrollments"
                                    onClick={onClickBurger}
                                    className="hover:text-blue-600 transition-colors border-blue-600 border-l-4 p-2 hover:border-b rounded-sm hover:bg-gray-100"
                                >
                                    My Enrollments
                                </Link>
                            </div>
